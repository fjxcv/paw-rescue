# -*- coding: utf-8 -*-
"""Create adopt questionnaire display helpers (UTF-8 safe)."""
from pathlib import Path

ROOT = Path(__file__).resolve().parent.parent
PATH = ROOT / 'frontend/src/utils/adoptQuestionnaireDisplay.js'

CONTENT = r'''const QUESTIONNAIRE_FIELD_ORDER = [
  'full_name',
  'address',
  'phone',
  'wechat',
